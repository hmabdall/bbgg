...
// Mon Jul  1 14:15:49 2013 by ROOT version 5.32/00
...
#ifdef sigReader_cxx
sigReader::sigReader(TTree *tree) : fChain(0) 
{
...
Int_t sigReader::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t sigReader::LoadTree(Long64_t entry)
{
...
void sigReader::Init(TTree *tree)
{
...
void sigReader::Show(Long64_t entry)
{
...
Int_t sigReader::Cut(Long64_t entry)
{
